...
class Bimo():
    ...
    def __init__(self):
        ...
        # Servos
        self.servo_max = [90.0, 90.0, 90.0, 12.0, 140.0, 140.0, 93.0, 93.0]
        self.servo_min = [-90.0, -90.0, -12.0, -90.0, 0.0, 0.0, -93.0, -93.0]
        self.sit_pose = [-47.5, -47.5, 0, 0, 140, 140, 92.54, 92.54]
        self.stand_pose = [-30.0, -30.0, 0.0, 0.0, 60.0, 60.0, 30.0, 30.0]
